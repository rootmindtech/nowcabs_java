...
public class Messaging {
  ...
  private static final String PROJECT_ID = "nowcabs";
  ...
  private static final String TITLE = "NOW";
  private static  String BODY = "Notification from NOW";
  ...
  private static String getAccessToken() throws IOException {
	  ...
	  //System.out.println("path2 "+ filePath);
		...
		InputStream serviceAccount = classLoader.getResourceAsStream("nowcabs-firebase-adminsdk-crv2v-475b4b9c21.json");
   ...
   * @throws IOException
   */
  public static void sendOverrideMessage() throws IOException {
  ...
  public static void sendOverrideMessage(String MSG_CODE, String token, String message) throws IOException {
	    JsonObject overrideMessage = buildOverrideMessage(MSG_CODE, token, message);
	    System.out.println("FCM request body for override message:");
	    prettyPrint(overrideMessage);
	    sendMessage(overrideMessage);
	  }
  ...
  private static JsonObject buildOverrideMessage(String MSG_CODE, String token, String message) {
	    JsonObject jNotificationMessage = buildNotificationMessage(MSG_CODE, token, message);
  ...
  public static void sendCommonMessage(String MSG_CODE, String token, String message) throws IOException {
	    JsonObject notificationMessage = buildNotificationMessage(MSG_CODE, token, message);
	    System.out.println("FCM request body for message using common notification object:");
	    prettyPrint(notificationMessage);
	    sendMessage(notificationMessage);
  }
  ...
  private static JsonObject buildNotificationMessage(String MSG_CODE, String token, String message) {
	  
	  
	    JsonObject jNotification = new JsonObject();
	    jNotification.addProperty("title", TITLE + " - " + MSG_CODE);
